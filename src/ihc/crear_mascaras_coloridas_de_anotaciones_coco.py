...
#Código alternativo a src/ihc/crear_mascaras_de_anotaciones_coco.py cuya función es crear las máscaras en formato .png con colores distintos
# ya que el código normal las guarda en escalas de gris, lo cual no es óptimo para observar las máscaras ground_truth.
...
for ruta_carpeta in rutas_relativas_imagenes:
    ...
    for anotacion in anotaciones:
        ...
        for imagen in informacion_imagenes:
            ...
            io.imsave(nombre_archivo_imagen, color_seg)
